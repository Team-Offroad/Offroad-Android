...
class TokenPreferencesImpl
    @Inject
    constructor(
        @Named(TOKEN_DATA_STORE_NAME) private val dataStore: DataStore<Preferences>,
    ) : TokenPreferences {
        ...
        override val deviceToken: Flow<String> =
            dataStore.data.map { preferences ->
        ...
        companion object {
            const val TOKEN_DATA_STORE_NAME = "TOKEN_DATA_STORE"
        }
    }
