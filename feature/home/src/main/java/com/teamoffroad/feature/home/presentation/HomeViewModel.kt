...
constructor(
    ...
    private fun updateMotionImageUrl(motionImageUrl: String?) {
        val currentUrl = _motionCharacterUrl.value
        val actualPath = motionImageUrl?.substringBefore("?") ?: motionImageUrl
        val currentPath = currentUrl?.substringBefore("?") ?: currentUrl
